...
Mean number of steps taken each day is : `r meanSteps`.    
Median number of steps taken each day is : `r mediSteps`.
...
Which 5-minute interval, on average across all the days in the dataset, contains the maximum number of steps?  Answer: `r maxInterval`
...
After Na's filledd, mean number of steps taken each day is : `r meanStepsAfterFilled`. median number of steps taken each day is : `r mediStepsAfterFilled`.
